        ...
        <div class="actions-card">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <input type="text" id="entregaSearch" class="form-control ms-3 searchQuerys" placeholder="Pesquisar por numero ou cliente" style="width: 280px;">
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="entregaTable" class="table table-hover table-transparent align-middle loader-table">
                            <thead>
                            <tr>
