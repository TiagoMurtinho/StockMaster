        ...
        <div class="actions-card">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <input type="text" id="userSearch" class="form-control form-control ms-3" placeholder="Pesquisar por nome" style="max-width: 250px;">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="userTable" class="table table-hover table-transparent align-middle">
                            <thead>
                            <tr>
